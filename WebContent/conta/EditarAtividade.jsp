					...
					<ul class="nav">
						...
						<li class="dropdown active">
							...
							<ul class="dropdown-menu">
								...
								<li class="active"><a href="EditarAtividade.jsp">Editar Atividade</a></li>
								<li class="divider"></li>
	...
	<div class="container">
		<table class="span12 table table-striped table-bordered table-hover table-condensed">
			...
			for (AtividadeCompleto atv : atividades) {
				...
				out.println("<td><a href=\"SelecionarAtividade?codAtividade="
							+ atv.getCodAtividade() + "\">Selecionar Atividade</a></td>");
				out.println("</tr>");
				out.println("</tbody>");
			}
			%>
		...
		<center>
			<font color="red">${erroAtividade}</font>
		</center>
	</div>
	...
	<div class="container">
		<header class="page-header">
			<div class="container">
				...
				<p class="lead">Edite a sua atividade!</p>
				<p><font class="span12" color="green">${sucesso}</font></p>
			</div>
			<center>
				<form class="navbar-form pull-left" method="post" action="EditarAtividade">
					<input type="hidden" name="txtCodAtividade" value="${id}"/>
					<input type="hidden" name="txtIdDisciplina" value="${idDisciplina}"/>
