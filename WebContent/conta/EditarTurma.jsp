...
<body>
					...
					<ul class="nav">
						...
						<li class="dropdown active">
							...
							<ul class="dropdown-menu">
								...
								<li  class="active"><a href="EditarTurma.jsp">Editar Turma</a></li>
								<li class="divider"></li>
	...
	<div class="container">
		<table class="span12 table table-striped table-bordered table-hover table-condensed">
			...
			for(Turma t :turmas) {
				...
				out.println("<td><a href=\"SelecionarTurma?idTurma="+t.getIdTurma()+"\">Selecionar Turma</a></td>");
				out.println("</tr>");
				out.println("</tbody>");
			}
			%>
	...
	<div class="container">
		<header class="page-header">
			<div class="container">
				<h1>Editar Turma</h1>
				<p class="lead">Edite o que estiver errado para você</p>
			</div>
		</header>
		<center>
			<form class="navbar-form pull-left" method="post" action="EditarTurma">
				<input type="hidden" name="txtIdTurma" value="${id}"/>
				<div class="control-group input-prepend span12">
					<span class="add-on btn-inverse">Nome da Instituição</span>
					<input type="text" name="txtInstitucao" class="span4" id="prependInput"
					placeholder="Instituição de Ensino" value="${instEnsino}"/>
				</div>
				...
				<div class="control-group input-prepend span12">
					<label class="control-label">Como o boletim é formado:</label>
				...
				<div class="control-group input-prepend span12">
					...
					placeholder="Curso superior ou ano de escola" value="${curso}"/>
				</div><br />
				<font color="red">${erroCurso}</font>
				<div class="control-group input-prepend span12">
					<input type="submit" class="btn btn-primary btn-sm pull-left span5" value="Editar Turma" />
				</div>
				<div class="control-group input-prepend span12">
