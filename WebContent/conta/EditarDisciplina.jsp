					...
					<ul class="nav">
						...
						<li class="dropdown active">
							...
							<ul class="dropdown-menu">
								...
								<li class="active"><a href="EditarDisciplina.jsp">Editar Disciplina</a></li>
								<li class="divider"></li>
		...
		<table class="span12 table table-striped table-bordered table-hover table-condensed">
			...
			for(DisciplinaTurmaUsuario d : dtus) {
				...
				out.println("<td><a href=\"SelecionarDisciplina?idDisciplina="+d.getIdDisciplina()
						+"&page=EditarDisciplina\">Selecionar Disciplina</a></td>");
				out.println("</tr>");
				out.println("</tbody>");
			}
			%>
	...
	<div class="container">
		<header class="page-header">
			<div class="container">
				...
				<p class="lead">Edite suas disciplinas!</p>
			</div>
		</header>
		<center>
			<form class="navbar-form pull-left" method="post" action="EditarDisciplina">
				...
				<div class="control-group btn-group input-prepend span12" data-toggle="buttons">
					...
					<input type="text" name="txtDisciplina" class="span4" id="prependInput"
					placeholder="Nome da da disciplina ou matéria" value="${disciplina}"/>
				</div><br />
				...
				<div class="control-group input-prepend span12">
					<input type="submit" class="btn btn-primary btn-sm pull-left span5" value="Editar Disciplina" />
				</div>
				<div class="control-group input-prepend span12">
